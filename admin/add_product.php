...
include 'header.php'; ?>
    <div class="admin-content-container">
        <h2 class="admin-heading">Add New Publication</h2>
        <form id="createProduct" class="add-post-form row" method="post" enctype="multipart/form-data">
            <div class="col-md-9">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control product_title" name="product_title" placeholder="Publication Title" requried/>
                </div>
                ...
                <div class="form-group sub_category">
                    <label for="">Publication Sub-Category</label>

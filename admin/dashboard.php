        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="detail-box">
                    ...
                    <span class="count-tag">Publications</span>
                </div>
            </div>
            <div class="col-md-4">
                <?php
            ...
            <div class="col-md-4">
                <div class="detail-box">
                    <?php
                        $db = new Database();
                        $db->select('brands','brand_title',null,'1 GROUP BY brand_title',null,0);
                        $brands = $db->getResult();
                    ?>
                    <span class="count"><?php echo count($brands); ?></span>
                    <span class="count-tag">Publishers</span>
                </div>
            </div>
            <div class="col-md-4">
                <div class="detail-box">

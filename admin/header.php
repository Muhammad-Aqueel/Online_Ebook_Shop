                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-3" id="admin-menu">
                         <ul class="menu-list">
                            ...
                            <li <?php if(basename($_SERVER['PHP_SELF']) == "products.php") echo 'class="active"'; ?>><a href="products.php">Publications</a></li>
                            ...
                            <li <?php if(basename($_SERVER['PHP_SELF']) == "brands.php") echo 'class="active"'; ?>><a href="brands.php">Publishers</a></li>
